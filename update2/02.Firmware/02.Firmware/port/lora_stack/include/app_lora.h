...
#define APP_LORA_BW_OPTIMIZE_SPEED                              2
#define APP_LORA_SF_OPTIMIZE_SPEED                              7
#define APP_LORA_CODINGRATE                                     1		// [1: 4/5, 2: 4/6,  3: 4/7,  4: 4/8]
#define APP_LORA_PREAMBLE_LENGTH                                8  // Same for Tx and Rx
#define APP_LORA_SYMBOL_TIMEOUT                                 0   // Symbols
...
/**
 * @brief           Lora HAL enter force shutdown mode
 */
