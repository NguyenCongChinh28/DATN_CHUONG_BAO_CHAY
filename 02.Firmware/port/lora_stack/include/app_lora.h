...
#define APP_LORA_ID_ACK 0x04
#define APP_LORA_ID_UPDATE_RELAY_STATUS 0x05
#define APP_LORA_ID_KEEP_ALIVE 0x06
#define APP_LORA_ID_LORA_JOIN_OK 0x07
#define APP_LORA_ID_POLL_ONLY_ONE_NODE	0x08
