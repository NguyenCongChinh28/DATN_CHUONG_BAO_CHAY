...
/* Private defines -----------------------------------------------------------*/
#define BT_ALARM_Pin GPIO_PIN_1
#define BT_ALARM_GPIO_Port GPIOA
#define BT_PAIR_Pin GPIO_PIN_2
#define BT_PAIR_GPIO_Port GPIOA
#define LORA_SPI_CS_Pin GPIO_PIN_4
#define LORA_SPI_CS_GPIO_Port GPIOA
#define LORA_DIO1_ISR_Pin GPIO_PIN_4
#define LORA_DIO1_ISR_GPIO_Port GPIOC
#define LORA_DIO1_ISR_EXTI_IRQn EXTI4_IRQn
...
#define LORA_RESET_PIN_GPIO_Port GPIOB
