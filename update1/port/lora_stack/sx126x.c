...
{
#if DEBUG_SX126X
    DEBUG_PRINTF("Set Dio2 as rf sw ctrol\r\n");
#endif
...
void SX126xGetRxBufferStatus( uint8_t *payloadLength, uint8_t *rxStartBufferPointer )
{
    ...
    {
#if DEBUG_SX126X
        DEBUG_PRINTF("Read payload len in fifo buffer\r\n");
#endif
